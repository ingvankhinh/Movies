...
const movieTemplate = (movieDetail) => {
	...
	return `
		...
		<article data-value=${dollars} class="is-primary notification">
			<p class="title">${movieDetail.BoxOffice}</p>
			<p class="subtitle">Box Office</p>
		</article>
		<article data-value=${metaScore} class="is-primary notification">
			<p class="title">${movieDetail.Metascore}</p>
			<p class="subtitle">Meta Scores</p>
		</article>
		<article data-value=${imdbRating} class="is-primary notification">
			<p class="title">${movieDetail.imdbRating}</p>
			<p class="subtitle">IMDB Rating</p>
		</article>
		<article data-value=${imdbVotes}  class="is-primary notification">
